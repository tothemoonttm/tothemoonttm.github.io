! function(e, t) {
    ...
    return function(e) {
        ...
        function i(e) {
            ...
            if (void 0 === t) throw new Error("No chain found matching chainId: " + e);
            return t
        }
        ...
        function o(e, t) {
            ...
            if (a && a.length && (n = a[0]), void 0 === n) throw new Error(`No chain found matching ${e}: ${t}`);
            return n
        }
        ...
        t.getAllChains = r, t.getChain = i, t.getChainByChainId = function(e) {
            return i(e)
        }, t.getChainByKeyValue = o, t.getChainByNetworkId = s, t.convertNetworkIdToChainId = function(e) {
            return s(e).chainId
