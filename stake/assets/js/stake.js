var walletAddress = null,
  ...
  contract = null,
  stakingAddress = "0xdb5C97473C8B78d0d542004c7aCA540233601Cc0",
  contractAddress = "0x29114A0642Dc70Cc82bEB374c6e1c23E470A267E",
  isMetaMask = true,
  web3 = null,
  web3Modal = null,
  provider = null,
...
function initialiseContracts() {
  ...
  getUserInfo().then(
    function (info) {
      ...
      $(".emergencyWithdrawBtn").on("click", function () {
        stakingContract.methods
          .emergencyWithdraw()
          .send({
            from: walletAddress,
          ...
          function (res, err) {
            ...
            $(".stakeBtn").on("click", function () {
              ...
              if (isApproved) {
                ...
                stakingContract.methods
                  .deposit(correctAmount.toString())
                  .send({
                    from: walletAddress,
                  })
                  .then(function (res, err) {
